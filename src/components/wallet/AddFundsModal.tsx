            ...
            >
              <div className="bg-[#1a1a2e] border-2 border-main rounded-lg shadow-brutal-lg p-4 sm:p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-lg sm:text-xl font-bold text-white">Add funds to your RugMania wallet</h2>
                  <button
                    onClick={onClose}
                  ...
                  {activeTab === 'transfer' ? (
                    <div className="space-y-3">
                      <p className="text-sm text-zinc-400">
                        Send MNT from your external wallet (e.g., MetaMask) to this address on <span className="text-main font-semibold">Mantle Sepolia</span>:
                      </p>
                      
                      {/* Address Display */}
                      <div className="bg-zinc-900 border border-zinc-700 rounded-md p-4">
                        <p className="text-xs text-zinc-500 mb-2">Your RugMania wallet address</p>
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <button
                            onClick={handleCopy}
                            className="shrink-0 w-9 h-9 flex items-center justify-center rounded-md bg-main border-2 border-black text-black hover:bg-lime-300 transition-colors"
                            title="Copy address"
                          >
                      ...
                      <div className="bg-purple-900/20 border border-purple-500/30 rounded-md p-3">
                        <p className="text-xs text-purple-300">
                          ⚠️ Make sure to send on <strong>Mantle Sepolia testnet</strong>. Funds sent on other networks will be lost.
                        </p>
                      </div>
                    </div>
                  ) : (
                    <div className="space-y-3">
                      <p className="text-sm text-zinc-400">
                        Scan this QR code to send MNT on <span className="text-main font-semibold">Mantle Sepolia</span>:
                      </p>
                      ...
                      <div className="bg-zinc-900 border border-zinc-700 rounded-md p-3">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <button
                            onClick={handleCopy}
                            className="shrink-0 w-8 h-8 flex items-center justify-center rounded-md bg-main border-2 border-black text-black hover:bg-lime-300 transition-colors"
                          >
